sap.ui.define([
	"sap/ui/test/Opa5",
	"opensap/products/ManageProducts/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("opensap.products.ManageProducts.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "opensap.products.ManageProducts",
					async: true
				},
				hash: oOptions.hash,
